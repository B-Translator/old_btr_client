...
* Installation
  ...
  This will install in ~/var/chroot/bcl~ a minimal ubuntu system,
  ...
  configurations of the system and prompt for customizing it (for
  example the domain, email address, etc.)

  The installation script will also create the init script
  ~/etc/init.d/chroot-bcl~, which can be used to start and stop the services
  inside the chroot:
  #+BEGIN_EXAMPLE
  ...
  *Note:* The default options of the script are: =--arch=i386=,
  ...
  For development purposes, the scripts in ~btr_client/install/dev/~
...
* Documentation
  ...
  - Internal doc files:
    + [[https://github.com/B-Translator/btr_client/blob/master/README.org][README.org]] (this file)
    + [[https://github.com/B-Translator/btr_client/blob/master/dev/README.org][dev/README.org]] (tips for developers)
    + [[https://github.com/B-Translator/btr_client/blob/master/docs/INSTALL.org][docs/INSTALL.org]]
    + [[https://github.com/B-Translator/btr_client/blob/master/docs/NGINX.org][docs/NGINX.org]]
    + [[https://github.com/B-Translator/btr_client/blob/master/docs/tasks.org][docs/tasks.org]]
    + [[https://github.com/B-Translator/btr_client/blob/master/docs/notes.org][docs/notes.org]]
    + [[https://github.com/B-Translator/btr_client/blob/master/docs/README.org][docs/README.org]]
    + [[https://github.com/B-Translator/btr_client/blob/master/docs/btranslator-project.org][docs/btranslator-project.org]]
    + [[https://github.com/B-Translator/btr_client/blob/master/docs/btranslator-project.pdf][docs/btranslator-project.pdf]]
    + [[https://github.com/B-Translator/btr_client/blob/master/docs/uml/db_schema.org][docs/uml/db_schema.org]]
    + [[https://github.com/B-Translator/btr_client/blob/master/modules/custom/btrClient/README.org][modules/custom/btrClient/README.org]]
    + [[https://github.com/B-Translator/btr_client/blob/master/modules/features/README.org][modules/features/README.org]]
