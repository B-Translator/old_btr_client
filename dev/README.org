...
* Installation
  ...
  mkdir /var/chroot
  cd /var/chroot/
  git clone https://github.com/dashohoxha/dbox.git Btranslator
...
* Making a local git clone of the dev application
  ...
  *@dev* application (~/var/www/btr_dev~). For example this is the
  ...
  [[https://github.com/dashohoxha/dbox][GitHub repository]] it is easy to push commits from /btr_dev/ to
