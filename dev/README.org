...
* Pushing commits to github
  ...
  clones of the git repository at https://github.com/B-Translator/client
...
* Making a local git clone of the dev application
  ...
  *@dev* application (~/var/www/btr_dev~). For example this is the
  ...
  [[https://github.com/B-Translator/client][GitHub repository]] it is easy to push commits from /btr_dev/ to
