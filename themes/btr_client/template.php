 ...
 */
function btr_client_pager_previous($variables) {
 ...
 */
function btr_client_pager_next($variables) {
 ...
 */
function btr_client_pager_first($variables) {
 ...
 */
function btr_client_pager_last($variables) {
